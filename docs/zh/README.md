...
> **状态：** 生产可演示版 / 准生产 Beta  
> **验收基线：** e2e 13/13 · pytest 63 passed, 2 skipped · build ✓ · Vitest 19 · Playwright 4
...
| 17 | [17-上线前检查清单.md](./17-上线前检查清单.md) | 生产上线逐项检查 |
| 18 | [18-产品与运维评估.md](./18-产品与运维评估.md) | PM/测试运维综合评估与维护记录 |
